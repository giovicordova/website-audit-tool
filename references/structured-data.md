...
- [ ] Article schema on blog/content pages (with headline, author, datePublished, dateModified)
...
### NICE TO HAVE
- [ ] Product schema on product/pricing pages (with name, description, offers)
